  ...
  const check_exists = async (states) => {
    try {
      ...
      if (message.split(" ")[0] === "Already") {
        ToastsStore.info(
          "AUID or Email already Registered, Contact CPRD for further changes. "
        );
      }
  ...
  const departments = (value) => {
    if (value == "AIT") {
      return [
        ...
        "MSE|Manufacturing Science",
        "MT|Mechatronics Engineering",
        "MN|Mining Engineering",
        "MBA|Master of Buisness Administration",
        "MCA|Master of Computer Applications",
        "MCFI|M.Tech in Cyber Forensics and Information Security",
        "MCNE|M.Tech in Computer Network Engineering",
        "MCSE|M.Tech in Computer Science and Engineering",
        "MPSE|M.Tech in Power Systems and Engineering",
        "MDCE|M.Tech in Digital Communication and Engineering",
        "MBT|M.Tech in Bio Technology",
        "MMD|M.Tech in Machine Design",
        "OTH|Others",
      ];
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <input
                ...
                name="auid"
                onChange={(e) => {
                  setState({ ...state, auid: e.target.value });
                }}
              />
            </div>
            ...
            <div class="form-group">
              <select
                ...
                required
                onChange={(e) => {
                  setState({ ...state, college: e.target.value });
                }}
              >
        ...
        /> */}
            ...
            <div class="form-group">
              ...
              >
                ...
                <option value="LandD">Literary And Dramatics</option>
                <option value="LandS">Life Style</option>
                <option value="IandC">Intra-College</option>
                <option value="mis">Miscellaneous</option>
                <option value="mestori">Mestori</option>

                <option value="tfest">Technical Fest</option>
                <option value="CandE">Centralised Events</option>
                <option value="adv">Adventure</option>
                <option value="akv">AKV</option>
                <option value="sports">Sports</option>
                <option value="VandE">Video Editing</option>
                <option value="DandS">Defence Squad</option>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <input
                ...
                required
                onChange={(e) => {
                  setState({ ...state, calling: e.target.value });
                }}
              />
            </div>
            {/*  */}
            ...
            <div class="form-group">
              <textarea
                ...
                className="form-control"
                type="text"
                placeholder="Mention skills you have*"
                name="skills"
                required
                onChange={(e) => {
