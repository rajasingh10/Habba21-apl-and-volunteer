      ...
      <form onSubmit={e => {
        ...
        <div class="row register-form">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <select placeholder="College" class="form-control" required onChange={e => {
                ...
                <option value="AIEFL">Acharya Institute of English and Foriegn Languages</option>
                <option value="ASD">Acharya School of Design</option>
                <option value="AIAS">Acharya Institute of Allied Health Science</option>
            ...
            <div class="form-group">
              ...
              <select placeholder="department" class="form-control" required onChange={e => {
...
<div class="form-group">
              <select placeholder="Preference1" class="form-control" required onChange={e => {
               ...
               <option selected disabled value="">
                ...
                <option value="Literary&Dramatics">Literary And Dramatics</option>
                <option value="LifeStyle">Life Style</option>
                <option value="Intracolleiate">Intra-College</option>
                ...
                <option value="DefenceSquad">Defence Squad</option>
            ...
            <div class="form-group">
              <select placeholder="" class="form-control" required onChange={e => {
